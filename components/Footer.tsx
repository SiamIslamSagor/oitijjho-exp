      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            >
              <a
                ...
                aria-label="Facebook"
                className="w-8 h-8 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-600 hover:bg-gradient-to-r hover:from-[#FF5722]/10 hover:to-[#FF9800]/10 hover:border-[#FF5722]/30 hover:text-[#FF5722] transition-colors"
              >
                <svg
          ...
          <div>
            ...
            >
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:border-[#FF5722] focus:ring-1 focus:ring-[#FF5722] transition-colors"
                required
              />
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                type="submit"
                className="absolute right-1.5 top-1.5 bg-gradient-to-r from-[#FF5722] to-[#FF9800] text-white px-4 py-1.5 rounded-md font-medium text-sm shadow-sm"
              >
                Subscribe
              </motion.button>
              <AnimatePresence>
                {isSubscribed && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 10 }}
                    className="absolute left-0 right-0 mt-2 text-[#FF5722] text-sm font-medium"
                  >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            © {currentYear} Oitijjho Express. All rights reserved.
          </motion.div>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
